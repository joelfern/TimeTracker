...
module.exports = function ( EndUser ) {
	...
	//EndUser.disableRemoteMethod('create', true);
	EndUser.disableRemoteMethod( 'upsert', true );
	EndUser.disableRemoteMethod( 'updateAll', true );

	EndUser.disableRemoteMethod( 'findOne', true );

	EndUser.disableRemoteMethod( 'deleteById', false );

	EndUser.disableRemoteMethod( 'confirm', true );
	EndUser.disableRemoteMethod( 'count', true );
	EndUser.disableRemoteMethod( 'exists', true );
	EndUser.disableRemoteMethod( 'createChangeStream', true );

	EndUser.disableRemoteMethod( '__count__accessTokens', false );
	EndUser.disableRemoteMethod( '__create__accessTokens', false );
	EndUser.disableRemoteMethod( '__delete__accessTokens', false );
	EndUser.disableRemoteMethod( '__destroyById__accessTokens', false );
	EndUser.disableRemoteMethod( '__findById__accessTokens', false );
	EndUser.disableRemoteMethod( '__get__accessTokens', false );
	EndUser.disableRemoteMethod( '__updateById__accessTokens', false );

	EndUser.disableRemoteMethod( '__count__roles', false );
	EndUser.disableRemoteMethod( '__create__roles', false );
	EndUser.disableRemoteMethod( '__delete__roles', false );
	EndUser.disableRemoteMethod( '__destroyById__roles', false );
	EndUser.disableRemoteMethod( '__findById__roles', false );
	EndUser.disableRemoteMethod( '__get__roles', false );
	EndUser.disableRemoteMethod( '__updateById__roles', false );
	EndUser.disableRemoteMethod( '__exists__roles', false );
	EndUser.disableRemoteMethod( '__link__roles', false );
	EndUser.disableRemoteMethod( '__unlink__roles', false );
};
